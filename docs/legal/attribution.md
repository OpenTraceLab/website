...
OpenTraceLab is based on the [sigrok](https://sigrok.org) project, originally licensed under CC-BY-SA 3.0. We gratefully acknowledge the foundational work of the sigrok community.
...
- **Website:** [sigrok.org/wiki/Libsigrok](https://sigrok.org/wiki/Libsigrok)
#### PulseView → OpenTraceView
- **Original project:** PulseView
- **Original license:** GPL-3.0-or-later
- **Original authors:** Joel Holdsworth, Gareth McMullin, and contributors
- **Website:** [sigrok.org/wiki/PulseView](https://sigrok.org/wiki/PulseView)
...
- **Website:** [sigrok.org/wiki/Libsigrokdecode](https://sigrok.org/wiki/Libsigrokdecode)
### Documentation Attribution
Portions of this documentation are adapted from the sigrok project documentation, originally licensed under CC-BY-SA 3.0:
- Installation guides
- Hardware compatibility information
- Protocol decoder documentation
- Getting started tutorials
- API documentation
**Original sigrok documentation:** [sigrok.org/wiki/](https://sigrok.org/wiki/)
...
- **License:** LGPL-2.1
- **Website:** [libusb.info](https://libusb.info/)
...
- **License:** LGPL-2.1
- **Website:** [gtk.org](https://www.gtk.org/)
...
- **License:** GPL-3.0
- **Website:** [swig.org](http://www.swig.org/)
...
Various manufacturers provide firmware for their devices:
- Saleae Logic series
- Rigol oscilloscopes
- Hantek devices
...
Many protocol decoders were originally developed for sigrok:
- I²C, SPI, UART decoders
- Automotive protocol decoders (CAN, LIN)
- Audio protocol decoders (I²S, AC'97)
- And many others
**Original authors:** Listed in individual decoder files
### Community Contributions
Additional decoders contributed by the OpenTraceLab community:
- Enhanced protocol support
- New device-specific decoders
- Performance improvements
## Documentation Sources
### Technical References
Protocol documentation sourced from:
- IEEE standards documents
- Manufacturer datasheets
- Industry specifications
- Open source protocol implementations
### Educational Content
Learning materials adapted from:
...
## Community Contributions
### Code Contributors
OpenTraceLab includes contributions from:
- Original sigrok developers
- OpenTraceLab community members
...
We thank all contributors to both sigrok and OpenTraceLab projects. Individual contributions are tracked in:
- Git commit history
...
1. **Software attribution** - Include GPL license and copyright notices
2. **Documentation attribution** - Credit CC-BY-SA sources when adapting
3. **sigrok attribution** - Acknowledge sigrok project heritage
4. **Third-party attribution** - Include required third-party notices
### Attribution Format
Suggested attribution text:
```
Based on OpenTraceLab (https://opentracelab.org/),
which is derived from the sigrok project (https://sigrok.org/).
Licensed under GPL-3.0-or-later.
```
### Commercial Use
For commercial use requiring different attribution:
